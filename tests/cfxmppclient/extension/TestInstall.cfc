<cfcomponent displayname="TestInstall"  extends="mxunit.framework.TestCase">
  ...
  <cffunction name="setUp" returntype="void" access="public">
		<cfset variables.extensionTag = "cfxmppclient" />
	...
	<cffunction name="testInstall" access="private">
		...
		<cfscript>
			...
			if(directoryExists("zip://" & expandPath("#variables.extensionzip#!") & "#variables.extensionTag#/cfc/#rereplace(variables.extensionTag,'^cf','')#.cfc")) {
