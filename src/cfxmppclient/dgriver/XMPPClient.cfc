<cfcomponent extends="Gateway">
    ...
    <cfset fields=array(
		...
		field("secure protocol","secureprotocol","",true,"Secure Protocol","text"),
		field("securerequirement","securerequirement","false",true,"Require Secure","text"),
		field("retries","retries","false",true,"retry","text"),
		field("retryinterval","retryinterval","5",true,"retry Interval","text"),
		...
		field("Add Buddy Request","onAddBuddyRequest","onAddBuddyRequest",false,"called when buddy request","text")
		field("Add Buddy Response","onAddBuddyResponse","onAddBuddyResponse",false,"called when buddy Response","text")
		field("Add Buddy Response","onAddBuddyResponse","onAddBuddyResponse",false,"called when buddy Response","text")
